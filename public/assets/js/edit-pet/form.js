export class EditPetForm {
    ...
    _cacheElements() {
        this._formElement = document.querySelector('#edit-pet-form');
        this._inputsArea = {
    ...
    _validateNameField(inputElement, inputArea) {
        ...
        const invalidErrorElement = inputArea.querySelector(EditPetForm.CSS_CLASSES.ERROR_INVALID);
        ...
        const hasMinLength = this._hasMinLength(inputElement.value, EditPetForm.VALIDATION_RULES.NAME_MIN_LENGTH);
    ...
    _validateEmptyInput(inputElement, inputArea) {
        ...
        const requiredErrorElement = inputArea.querySelector(EditPetForm.CSS_CLASSES.ERROR_REQUIRED);
    ...
    _toggleErrorMessage(errorElement, shouldShow) {
        ...
        errorElement.classList.toggle(EditPetForm.CSS_CLASSES.ERROR_VISIBLE, shouldShow);
    }
